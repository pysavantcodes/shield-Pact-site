...
__NFT.prototype.setURI = async function(uri){
	return await this._contract.setURI(uri);
}

// __NFT.prototype.getURI = async function(){
// 	return await this._contract.baseURI();
// }

__NFT.prototype.nftURI = async function(itemId){
	return await this._contract.tokenURI(itemId);
}
...
IClient.prototype.init = function(){//MOCKED HTTP REQUEST
	/*const auth =
	...
	this._client.add = async(fileObj)=>({path:`path to ${fileObj}`,cid:uuidv4()});
}


IClient.prototype.uploadFileIPFS = async function(fileObj){
	console.log(this._client);
	let added = await this._client.add(fileObj);
	return added;//{cid,path}
}
