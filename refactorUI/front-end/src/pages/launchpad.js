  ...
  return (
    ...
    <div className="launchpad">
      <section className="--full-page">
        <button className="btn" style={{margin:"0",fontSize:"12px", marginBottom:"5px"}}><Link to="/createtoken">Create a Token</Link></button>
        <button className="btn" style={{margin:"0",fontSize:"12px"}}><Link to="/createlaunchpad">Create Launchpad</Link></button>
