	...
	return (
		<div className="wallet">
            ...
            <div>
                ...
                <p>Service: Programming (Web Builders)</p>
            </div>
        </div>
	);
}
...
const Search = ()=>{
	...
	<div className="search">
        <input type="text" placeholder="Search Services" name="" id=""/>
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
    </div>
	);
}
	...
	<div className="categories">
        ...
        <ul>
            <li>
                ...
                <div>
                    Influencer Content
                    <p>Videos, Pictures, <a href="/nftpage/index.html">NFTs</a>, Music</p>
                </div>
            </li>
            <li>
            ...
            <li>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-video"><polygon points="23 7 16 12 23 17 23 7"></polygon><rect x="1" y="5" width="15" height="14" rx="2" ry="2"></rect></svg>
                <div>
                    Video & Animation
            ...
            <li>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-terminal"><polyline points="4 17 10 11 4 5"></polyline><line x1="12" y1="19" x2="20" y2="19"></line></svg>
                <div>
                    Programming & Tech
...
const Task = ()=>{
	return (
		 <div className="task">
	        <div className="left">
	            <h3>Name of Task</h3>
	            <p>From : 0xnd9nwidcbubefhdb298d</p>
	        </div>
	        <p className="center">
	            4 days ago
	        </p>
	        <div className="buttons">
	            ...
	            <button className="btn-border">Decline Offer</button>
	        </div>
	    </div>
	);
}
